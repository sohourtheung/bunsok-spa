    ...
    <div id="receipt-data">
        ...
        <table>
            <tbody>
                ...
                <tr >
                    <td style="padding: 5px;width:40%"><?php echo e(trans('file.Review by')); ?></td>
                    <td style="padding: 5px;width:40%"><?php echo e(trans('file.Customer')); ?></td>
                    <td style="padding: 5px;width:40%"><?php echo e(trans('file.Accounting')); ?></td>
                </tr>
        ...
        <!-- <div class="centered" style="margin:30px 0 50px">
            ...
            <?php echo e(trans('file.Developed By')); ?> Samut Soft</strong></small>
        </div> -->
    </div>
</div>
