    ...
    <div class="table-responsive">
        <table id="transfer-table" class="table table-striped transfer-list">
            ...
            <tbody>
                ...
                ?>
                <tr class="transfer-link" data-transfer='["<?php echo e(date($general_setting->date_format, strtotime($transfer->created_at->toDateString()))); ?>", "<?php echo e($transfer->reference_no); ?>", "<?php echo e($status); ?>", "<?php echo e($transfer->id); ?>", "<?php echo e($from_warehouse->name); ?>", "<?php echo e($from_warehouse->phone); ?>", "<?php echo e($from_warehouse->address); ?>", "<?php echo e($to_warehouse->name); ?>", "<?php echo e($to_warehouse->phone); ?>", "<?php echo e($to_warehouse->address); ?>", "<?php echo e($transfer->total_tax); ?>", "<?php echo e($transfer->total_cost); ?>", "<?php echo e($transfer->shipping_cost); ?>", "<?php echo e($transfer->grand_total); ?>", "<?php echo e($transfer->note); ?>", "<?php echo e($user->name); ?>", "<?php echo e($user->email); ?>"]'>
