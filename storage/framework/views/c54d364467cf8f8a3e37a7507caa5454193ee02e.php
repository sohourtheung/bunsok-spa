                        ...
                        <div class="col-md-12 mt-1 table-container">
                            <table id="product-table" class="table product-list">
                                ...
                                <?php for($i=0; $i < ceil($product_number/5); $i++): ?>
                                    <tr>
                                        <td class="product-img" title="<?php echo e($lims_product_list[0+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[0+$i*5]->code . ' (' . $lims_product_list[0+$i*5]->name . ')'); ?>"><img  src="<?php echo e(url('public/images/product',$lims_product_list[0+$i*5]->image)); ?>" width="100%" />
                                            <p><?php echo e($lims_product_list[0+$i*5]->name); ?></p>
                                        </td>
                                        <?php if(!empty($lims_product_list[1+$i*5])): ?>
                                        <td class="product-img" title="<?php echo e($lims_product_list[1+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[1+$i*5]->code . ' (' . $lims_product_list[1+$i*5]->name . ')'); ?>"><img  src="<?php echo e(url('public/images/product',$lims_product_list[1+$i*5]->image)); ?>" width="100%" />
                                        ...
                                        <td class="product-img" title="<?php echo e($lims_product_list[2+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[2+$i*5]->code . ' (' . $lims_product_list[2+$i*5]->name . ')'); ?>"><img  src="<?php echo e(url('public/images/product',$lims_product_list[2+$i*5]->image)); ?>" width="100%" />
                                        ...
                                        <td class="product-img" title="<?php echo e($lims_product_list[3+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[3+$i*5]->code . ' (' . $lims_product_list[3+$i*5]->name . ')'); ?>"><img  src="<?php echo e(url('public/images/product',$lims_product_list[3+$i*5]->image)); ?>" width="100%" />
                                        ...
                                        <td class="product-img" title="<?php echo e($lims_product_list[4+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[4+$i*5]->code . ' (' . $lims_product_list[4+$i*5]->name . ')'); ?>"><img  src="<?php echo e(url('public/images/product',$lims_product_list[4+$i*5]->image)); ?>" width="100%" />
...
$('#add-payment input[name="paying_amount"]').on("input", function() {
    $("#change").text( parseFloat( $(this).val() - $('input[name="paid_amount"]').val() ).toFixed(2) );
});
