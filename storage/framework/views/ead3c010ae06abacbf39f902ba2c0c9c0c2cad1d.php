...
<section>
    <div class="container-fluid">
        <?php if(in_array("sales-add", $all_permission)): ?>
            <a href="<?php echo e(route('sale.create')); ?>" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Sale')); ?></a>&nbsp;
            <a href="<?php echo e(url('sale/sale_by_csv')); ?>" class="btn btn-primary"><i class="fa fa-file"></i> <?php echo e(trans('file.Import Sale')); ?></a>
        <?php endif; ?>
    </div>
...
<script type="text/javascript">
    ...
    function saleDetails(sale){
        ...
        $.get('sale/product_sale/' + sale[13], function(data){
